...
###
#  This is based on the siriproxy-lotto Plugin from muhkuh0815
#  Dies basiert auf dem siriproxy-lotto Plugin von muhkuh0815
#  
#  Ich habe lediglich noch ein Lottozahlengenerator hinzugefügt.
#  zur Zeit nur die 6aus49. Füge 6aus45 später hinzu.
#
###
...
listen_for /(Generator|Zufallszahlen)/i do
	...
	say "Hier sind deine Zufallszahlen" + zahlen[0].to_s + zahlen[1].to_s + zahlen[2].to_s + zahlen[3].to_s + zahlen[4].to_s + zahlen[5].to_s + "Und die Superzahl" + sz
	
request_completed
end
	    
# german Lotto numbers 4au49
...
if shaf =="timeout" 
    say "Es gab ein Problem beim einlesen der Lottodaten!"
    else
    doc = doc.to_s
    doc = doc.gsub(/<\/?[^>]*>/, "")
    dat = doc.match(/(hr)/)
